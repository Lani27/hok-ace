...
RULES = [
 ('ACE Tournament','y1285cnprk7',[
  ('Choose your Chessplayer','Six Chessplayers compete in the ACE Tournament. Each starts with 60 Health.'),
  ...
  ('Be the last survivor','A Chessplayer is eliminated at 0 Health. The last Chessplayer standing wins.')]),
 ('Chessplayers','e12866xbiwl',[
  ('Unique skills','Every Chessplayer has a unique skill. Select the skill button to see its details.'),
  ('Secret Skills','Every Chessplayer has a Secret Skill mission. Complete it to earn a Secret Skill Card.'),
  ('Exclusive talents','At Chessplayer level 6, claim an exclusive talent with a powerful effect.'),
  ('Level up','Spend Energy to raise your Chessplayer’s level. Each level-up unlocks one free talent. Levels marked with a unit-count icon also grant +1 deployment slot. Higher Chessplayer levels increase the chance of finding higher-tier hero cards.'),
  ('Free Chessplayer rotation','Before Platinum, free Chessplayers unlock according to your rank. After you reach Platinum, the standard weekly free rotation begins the following week.')]),
 ('Heroes','k1285b6imwl',[
 ...
 ('Energy','k1285pr5ujb',[
  ...
  ('Spending Energy','Hero cards always cost 3 Energy. An effect card’s cost appears in its upper-right corner. Leveling your Chessplayer also costs Energy; the level-up button shows the current cost.')]),
...
TACTICIANS = [
 ('Xiangxiang','xiangxiang','Bring your own firepower, then modify your weapon into different forms.',[
  ...
  [('Art of Gunnery','Deal a cumulative 10/15/20/30 damage to Chessplayers to earn a Weapon Modification Secret Skill Card.'),('Weapon Modification','Xiangxiang gains +20% Attack. Choose one weapon modification.')],
 ...
 ('Yaria','yaomei','Summon a fawn to absorb frontline damage and strengthen it through victories.',[
  [('Cute Fawn','At the start of the game, Yaria summons her beloved fawn. It gains 2 levels each round, plus 4 more if you won the previous battle.')],
  [('Super Cute Deer','Every 3 rounds, receive a Magical Fawn Secret Skill Card.'),('Magic Deer: Taunt','After combat begins, the fawn moves between enemies without collision. Every 3 seconds, it taunts enemies within 1 tile. +8 levels.'),('Magic Deer: Heavy Armor','The fawn can wear equipment and immediately equips a Glacial Buckler. +10 levels.'),('Magic Deer: Twin','At combat start, the fawn creates a copy of itself nearby. If you have won 5 battles this match, the fawn gains 12 levels. The original preview shows 0 wins.'),('Magic Deer: Resonance','Double the fawn’s level.'),('Magic Deer: Devotion','When the fawn dies, divide its levels evenly among your heroes as Temporary Levels.')],
  [('Giant Doll','The fawn gains 30 levels. Receive a Deer’s Protection item.'),('Deer’s Protection','Unique. 30% of the wearer’s incoming damage is transferred to the fawn.')]]),
 ('Bai Ge','baige','Combine heroes to earn copies, then split key cards with your Secret Skill.',[
  [('Divine Stroke','After every 4 hero combinations, Bai Ge receives an Improvisation card.'),('Improvisation','Receive a copy of a random deployed hero.')],
  [('Born with Talent','Use 6 Improvisation cards to receive an Inspiration Burst Secret Skill Card.'),('Inspiration Burst','Release 3 sword waves at 3 random non-awakened hero cards in your hand. Split each card into 2 Fleeting copies.')],
 ...
 ("Chang Xiao'e",'changxiaoe','Gain levels with an increasingly powerful skill and develop four elite heroes.',[
  [('Little Rabbit Assist','Use the skill to give a random hero +2 levels. For every previous use this match, the level gain increases by 1.')],
  [('Leaps and Bounds','When your heroes’ combined levels reach 50/150/375, receive a Little Rabbit Gift Secret Skill Card.'),('Little Rabbit Gift','Trigger Little Rabbit Assist once on each of 4 random deployed heroes. The base preview shows +2 levels.')],
  [('Moonlight Special','Whenever the bunny grants levels, every 5 levels also grant a random stat bonus: 15% Attack Speed, 2% physical and magical lifesteal, or 2 physical and magical Defense. Each time Little Rabbit Assist grants a total of 65 levels, receive a Little Rabbit Gift card.')]]),
 ('Naonao','naonao','Specialize in one faction and earn additional faction talents.',[
  [('Party Bubble','Choose one of two random factions. Your skill then becomes: spend 1 Energy to receive a hero card from that faction.')],
  [('Joyful Assembly','Deploy 6 heroes from your selected faction to earn a Many Friends Secret Skill Card.'),('Many Friends','Draw 4 random hero cards from the faction selected by your skill.')],
  [('Carnival Moment','Receive a Socialize card.'),('Socialize','Choose one of three talents associated with the faction selected by your skill.')]])
]

KEYWORDS = [
 ('Deploy','Triggers after you play this card.','d1284dm1gdr'),
 ('Initiate','Triggers at the start of combat.','l1284jfb9u9'),
 ...
 ('Steal','When this card is played, take levels from one random allied hero within 1 tile: up to 10 levels, excluding Temporary Levels.','f1284thzx39'),
 ...
 ('Withdraw','Triggers when this deployed hero is sold.','j1284qykxo5')
]

def keyword_video_slug(name):
    """Keep published MP4 URLs stable when glossary display names change."""
    return {'Initiate': 'engage', 'Steal': 'seize', 'Withdraw': 'exit'}.get(name, name.lower().replace(' ', '-'))
