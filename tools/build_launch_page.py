...
GROUPS = [
    ('Honor of Kings crossover rewards', [
        ...
        ('Find your perfect tactician', 'September 7 – October 7, 23:59',
         'Take the quiz to discover your ACE tactician match. Participate to receive The Cards Are Fine avatar frame in Honor of Kings. Players who previously played HOK Simulation Battle, and players who join through a friend’s shared link, can also claim the exclusive Training Sandtable board in ACE.', [6]),
    ]),
    ('Honor of Kings: ACE launch rewards', [
        ...
        ('Seven-day login: a tactician and a board', 'From September 10 • Ongoing',
         'Unlocked after launch. Log in on 7 days to claim a reward each day: Day 1 — 200 Diamonds; Day 2 — Zhuang Xiaoyu tactician; Day 3 — 1 Lineup Slot Card; Day 4 — 6 Treasure Coins; Day 5 — Dimensional Collapse attack effect for 30 days; Day 6 — Random Tactician Trial Card for 3 days; Day 7 — ACE Supermarket board.', [11]),
        ('Begin your journey: a tactician and a skin', 'From September 10 • Ongoing',
         'Eight days of missions unlock in sequence after launch. Complete 3 daily missions to earn 15 Journey Points. Exchange points for the Qiao Xi tactician and Qiao Xi — Crimson Koi Dream skin. Complete every mission to unlock challenge missions that award another 500 Diamonds. These challenge missions have a 90-day time limit.', [12]),
        ('Complete practice stages to unlock Naonao', 'From September 10 • Ongoing',
         'Complete any 3 reinforcement practice stages to claim the Naonao tactician. These stages help you move into training matches and learn basic lineups and battle techniques.', [13]),
